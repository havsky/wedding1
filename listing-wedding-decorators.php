...
<!-- head -->
<head>
<title>Wedding Decorators Category </title>
<meta charset="utf-8" />
      ...
      <div class="banner-dtl text-center">
        ...
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            ...
            <li class="active">Wedding Decorators</li>
          </ol>
        </div>
      </div>
    </div>
...
<body>
  <div class="container">
	<h1 align="center" style="padding-top: 20px;">Wedding Decorators</h1>
	<div class="line"></div>
    <br>
    <div class="row">
		<?php
		  include('dbcon.php');
		  $qry="SELECT * FROM `wedding_decorators`";
		   	  ...
		   	  ?>
	              ...
	              <div class="card" style="width:250px">
	                  ...
	                  <div class="card-body">
	                  	...
	                  	<button class="btn btn-success"><a href="contact-us-2.php">Book Now</a></button>
	                  </div>
	              </div>
	           	</div>          
		   	  <?php
