...
<!-- head -->
<head>
<title>Wedding Venue Category </title>
<meta charset="utf-8" />
      ...
      <div class="banner-dtl text-center">
        ...
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            ...
            <li class="active">Wedding Venue</li>
          </ol>
        </div>
      </div>
    </div>
...
<body>
  <div class="container">
	<h1 align="center" style="padding-top: 20px;">Wedding Venue</h1>
	<div class="line"></div>
    <br>
    <div class="row">
		<?php
		  include('dbcon.php');
		  $qry="SELECT * FROM `wedding_venue`";
		   ...
		   while ($data = mysqli_fetch_assoc($run))
		    {
		   	  ?>
	              ...
	              <div class="card" style="width:250px">
					  <img  src="uploadimg/<?php echo $data['img1']; ?>" class="card-img" style="width: 300px;height: 300px;">
	                  <div class="card-body">
