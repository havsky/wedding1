...
<!-- head -->
<head>
<title>Wedding Photography Category</title>
<meta charset="utf-8" />
      ...
      <div class="banner-dtl text-center">
        ...
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            ...
            <li class="active">Wedding Photography</li>
          </ol>
        </div>
      </div>
    </div>
...
<body>
  <div class="container">
	<h4 align="center" style="padding-top: 20px;">Wedding Photographers</h4>
	<div class="line"></div>
    <br>
    <br>
    <div class="row">
		<?php
		  include('dbcon.php');
		  $qry="SELECT * FROM `wedding_photographers`";
