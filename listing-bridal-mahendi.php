...
<!-- head -->
<head>
<title>Bridal Mahendi category </title>
<meta charset="utf-8" />
      ...
      <div class="banner-dtl text-center">
        ...
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            ...
            <li class="active">Wedding Mahendi</li>
          </ol>
        </div>
      </div>
    </div>
...
<body>
  <div class="container">
	<h1 align="center" style="padding-top: 20px;">Bridal Mahendi</h1>
	<div class="line"></div>
    <br>
    <div class="row">
		<?php
		  include('dbcon.php');
		  $qry="SELECT * FROM `bridal_mahendi`";
